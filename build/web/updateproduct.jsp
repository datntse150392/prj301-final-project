...
<html>
    ...
    <body  class="hero"style="background-image: url('header_layout/images/images_header/hero_5.jpg'); height: auto; padding-bottom: 5%">
        <%@include file="header1.jsp"%>
        <div class="container col-xl-10 col-xxl-8 px-4 py-5" style="width: 100%">
            <h3 style="text-align: center; color: white; margin-bottom: -30px;margin-top: -40px;">Cập nhật Thông Tin</h3>
