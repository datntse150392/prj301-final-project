...
<html>
    <head>
        ...
        <title>Danh sách cát vệ sinh</title>
    </head>
                ...
                <div class="row" style="place-content: center; width: auto">
                    <div class="col-lg-9" style="padding-left: 30px;">
                        ...
                        <div class="row" style="margin: 30px 0px; background-color: white">
                            <a class="col" style="color: black" href="list_product1?index_page=1">Trang đầu</a>
                            <c:forEach begin="1" end="${endPage}" var="i">
                                <a class="col" style="color: black" href="list_product1?index_page=${i}">${i}</a>
                            </c:forEach>
                            <a class="col" style="color: black" href="list_product1?index_page=${endPage}">Trang cuối</a>
                        </div>
                    </div>
                </div>
            </div>
